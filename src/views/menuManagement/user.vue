<template>
  ...
  <div class="app-container">
    ...
    <!-- 创建or编辑标签 -->
    <a-modal v-model="dialogVisible" title="添加角色" ok-text="确认" cancel-text="取消" @ok="submitForm('form')">
    ...
    >
      ...
      >
        ...
        <a-button type="primary" @click="updateRoles">
          更新
        </a-button>
      </div>
    </a-drawer>
...
<script>
import {getRoles,getRolesAuth,updateRolesAuth,addRoles,deletRoles,editRoles} from "@/api/menus/roles"
  ...
  data() {
    return {
      ...
      rules:{
        ...
        code:[{ required: true, message: '请输入角色标识', trigger: 'change' }]
      },
      // tree树形控件相关
      expandedKeys: [],
